...
* (**BREAKING**): Enable AngularNoNgAttributesSnapshotSerializer (created in [#97](https://github.com/thymikee/jest-preset-angular/pull/97)) by default ([#318](https://github.com/thymikee/jest-preset-angular/pull/318)).
...
* Fix: Add doctype to test environment ([#78](https://github.com/thymikee/jest-preset-angular/pull/78))
