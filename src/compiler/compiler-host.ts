...
export class NgJestCompilerHost implements ts.CompilerHost {
  ...
  constructor(private logger: Logger, private ngJestCfg: NgJestConfig, private options: CompilerOptions) {
  ...
  resolveModuleNames(
    ...
    return moduleNames.map((moduleName) => {
      ...
      // TODO: Run ngcc here see https://github.com/angular/angular-cli/blob/master/packages/ngtools/webpack/src/compiler_host.ts#L433
  ...
  resolveTypeReferenceDirectives(
    ...
    return typeReferenceDirectiveNames.map((typeDirectiveName) => {
      const { resolvedTypeReferenceDirective } = this._ts.resolveTypeReferenceDirective(
        ...
        containingFile,
        this.options,
        this._ts.createCompilerHost(this.options),
        redirectedReference,
      );

      // TODO: Run ngcc here see https://github.com/angular/angular-cli/blob/master/packages/ngtools/webpack/src/compiler_host.ts#L455
