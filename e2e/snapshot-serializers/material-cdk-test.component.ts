...
@Component({
    selector: 'material-cdk-test',
    standalone: true,
    template: `
        <div id="cdk-step-content-0-0" aria-labelledby="cdk-step-label-0-0" aria-controls="cdk-step-content-2-0">
            Step content
        </div>
...
export class MaterialCDKTestComponent {}
